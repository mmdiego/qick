...
// External Control  
   ...
   // input  wire             time_init_i    ,  // removed in 331b7a3
...
qproc_ctrl # (
   ...
   .c_clk_i             ( c_clk_i            ),
   .c_rst_ni            ( c_rst_ni           ),
   .t_proc_start_i      ( proc_start_i       ),
   .t_proc_stop_i       ( proc_stop_i        ),
   .c_core_start_i      ( core_start_i       ),
   .c_core_stop_i       ( core_stop_i        ),
   .t_time_rst_i        ( time_rst_i         ),
   .t_time_updt_i       ( time_updt_i        ),
   ...
   .cfg_dis_qnet        ( xreg_TPROC_CFG[9]  ),
   .cfg_en_io           ( xreg_TPROC_CFG[10] ),
   .cfg_dis_fifo_pause  ( xreg_TPROC_CFG[11] ),
