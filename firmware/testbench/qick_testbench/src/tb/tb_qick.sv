...
module tb_qick ();
  ...
  axi_mst_0_mst_t     axi_mst_xcom_agent;
  ...
  // Peripheral A signals
  logic        qp1_en_o;          
  logic [4:0]  qp1_op_o;
  logic [31:0] qp1_a_dt_o;        
  ...
  axi_mst_0 u_axi_mst_xcom_0 (
    ...
    .m_axi_arvalid (s_axi_xcom_arvalid ),
    .m_axi_awaddr  (s_axi_xcom_awaddr  ),
    .m_axi_awprot  (s_axi_xcom_awprot  ),
    .m_axi_awready (s_axi_xcom_awready ),
    .m_axi_awvalid (s_axi_xcom_awvalid ),
    .m_axi_bready  (s_axi_xcom_bready  ),
    .m_axi_bresp   (s_axi_xcom_bresp   ),
    .m_axi_bvalid  (s_axi_xcom_bvalid  ),
    .m_axi_rdata   (s_axi_xcom_rdata   ),
    .m_axi_rready  (s_axi_xcom_rready  ),
    .m_axi_rresp   (s_axi_xcom_rresp   ),
    .m_axi_rvalid  (s_axi_xcom_rvalid  ),
    .m_axi_wdata   (s_axi_xcom_wdata   ),
    .m_axi_wready  (s_axi_xcom_wready  ),
    .m_axi_wstrb   (s_axi_xcom_wstrb   ),
  ...
  axis_dyn_readout_v1 /*#(
    ...
    initial begin
      ...
      // Create agents.
      axi_mst_xcom_agent  = new("axi_mst_xcom VIP Agent",tb_qick.u_axi_mst_xcom_0.inst.IF);
      // Set tag for agents.
      axi_mst_xcom_agent.set_agent_tag("axi_mst_xcom VIP");
      // Start agents.
      axi_mst_xcom_agent.start_master();
