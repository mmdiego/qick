package qick_pkg;
  ...
  localparam VERSION = "0.1.0";

  /////////// XCOM ////////////
  //Opcodes
  localparam XCOM_RST         = 4'b1111  ;//LOC command
  localparam XCOM_WRITE_MEM   = 4'b0011  ;//LOC command
  localparam XCOM_WRITE_REG   = 4'b0010  ;//LOC command
  localparam XCOM_WRITE_FLAG  = 4'b0001  ;//LOC command
  localparam XCOM_SET_ID      = 4'b0000  ;//LOC command
  localparam XCOM_RFU2        = 4'b1111  ;
  localparam XCOM_RFU1        = 4'b1101  ;
  localparam XCOM_QCTRL       = 4'b1011  ;
  localparam XCOM_UPDATE_DT32 = 4'b1110  ;
  localparam XCOM_UPDATE_DT16 = 4'b1100  ;
  localparam XCOM_UPDATE_DT8  = 4'b1010  ;
  localparam XCOM_AUTO_ID     = 4'b1001  ;
  localparam XCOM_QRST_SYNC   = 4'b1000  ;
  localparam XCOM_SEND_32BIT_2= 4'b0111  ;
  localparam XCOM_SEND_32BIT_1= 4'b0110  ;
  localparam XCOM_SEND_16BIT_2= 4'b0101  ;
  localparam XCOM_SEND_16BIT_1= 4'b0100  ;
  localparam XCOM_SEND_8BIT_2 = 4'b0011  ;
  localparam XCOM_SEND_8BIT_1 = 4'b0010  ;
  localparam XCOM_SET_FLAG    = 4'b0001  ;
  localparam XCOM_CLEAR_FLAG  = 4'b0000  ;

  // Register ADDRESS
  localparam REG_XCOM_CTRL      = 0  * 4 ;
  localparam REG_XCOM_CFG       = 1  * 4 ;
  localparam REG_XCOM_AXI_DATA1 = 2  * 4 ;
  localparam REG_XCOM_AXI_DATA2 = 3  * 4 ;
  localparam REG_XCOM_ADDR      = 4  * 4 ;
  localparam REG_XCOM_EMPTY1    = 5  * 4 ;
  localparam REG_XCOM_ID        = 6  * 4 ;
  localparam REG_XCOM_FLAG      = 7  * 4 ;
  localparam REG_XCOM_DATA1     = 8  * 4 ;
  localparam REG_XCOM_DATA2     = 9  * 4 ;
  localparam REG_XCOM_MEM       = 10  * 4 ;
  localparam REG_XCOM_EMPTY2    = 11  * 4 ;
  localparam REG_XCOM_RX_DATA   = 12  * 4 ;
  localparam REG_XCOM_TX_DATA   = 13  * 4 ;
  localparam REG_XCOM_STATUS    = 14  * 4 ;
  localparam REG_XCOM_DEBUG     = 15  * 4 ;
