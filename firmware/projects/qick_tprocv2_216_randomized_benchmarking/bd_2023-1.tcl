...
proc create_hier_cell_clk_rst_wrapper { parentCell nameHier } {
  ...
  connect_bd_net -net clk_core_clk_out1 [get_bd_pins clk_core/clk_out1] [get_bd_pins slowest_sync_clk1] [get_bd_pins rst_core/slowest_sync_clk]
  ...
  connect_bd_net -net rst_adc_peripheral_aresetn [get_bd_pins rst_adc2/peripheral_aresetn] [get_bd_pins peripheral_aresetn1]
  connect_bd_net -net rst_core_peripheral_aresetn [get_bd_pins rst_core/peripheral_aresetn] [get_bd_pins peripheral_aresetn2]
  connect_bd_net -net rst_dac2_peripheral_aresetn [get_bd_pins rst_dac0/peripheral_aresetn] [get_bd_pins peripheral_aresetn3]
  connect_bd_net -net rst_dac3_peripheral_aresetn [get_bd_pins rst_dac2/peripheral_aresetn] [get_bd_pins peripheral_aresetn4]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins slowest_sync_clk2] [get_bd_pins rst_adc2/slowest_sync_clk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins slowest_sync_clk3] [get_bd_pins rst_dac0/slowest_sync_clk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac4 [get_bd_pins slowest_sync_clk4] [get_bd_pins rst_dac2/slowest_sync_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins slowest_sync_clk] [get_bd_pins rst_100/slowest_sync_clk] [get_bd_pins clk_core/clk_in1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins ext_reset_in] [get_bd_pins rst_adc2/ext_reset_in] [get_bd_pins rst_dac0/ext_reset_in] [get_bd_pins rst_dac2/ext_reset_in] [get_bd_pins rst_100/ext_reset_in]
...
proc create_hier_cell_signal_gen_wrapper { parentCell nameHier } {
  ...
  set_property CONFIG.N {12} $axis_signal_gen_v6_1
  ...
  set_property CONFIG.N {12} $axis_signal_gen_v6_2
  ...
  set_property CONFIG.N {12} $axis_signal_gen_v6_3
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins axis_cdcsync_v1_0/s0_axis] [get_bd_intf_pins s0_axis]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins axis_cdcsync_v1_0/s1_axis] [get_bd_intf_pins s1_axis]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins axis_cdcsync_v1_0/s2_axis] [get_bd_intf_pins s2_axis]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins axis_cdcsync_v1_0/s3_axis] [get_bd_intf_pins s3_axis]
  connect_bd_intf_net -intf_net axis_cdcsync_v1_0_m0_axis [get_bd_intf_pins sg_translator_0/s_tproc_axis] [get_bd_intf_pins axis_cdcsync_v1_0/m0_axis]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS1 [get_bd_intf_pins axis_register_slice_5/M_AXIS] [get_bd_intf_pins axis_signal_gen_v6_1/s1_axis]
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS2 [get_bd_intf_pins axis_register_slice_6/M_AXIS] [get_bd_intf_pins axis_signal_gen_v6_2/s1_axis]
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS3 [get_bd_intf_pins axis_register_slice_7/M_AXIS] [get_bd_intf_pins axis_signal_gen_v6_3/s1_axis]
  ...
  connect_bd_intf_net -intf_net axis_signal_gen_v6_0_m_axis1 [get_bd_intf_pins axis_register_slice_1/s_axis] [get_bd_intf_pins axis_signal_gen_v6_1/m_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v6_0_m_axis2 [get_bd_intf_pins axis_register_slice_2/s_axis] [get_bd_intf_pins axis_signal_gen_v6_2/m_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v6_0_m_axis3 [get_bd_intf_pins axis_register_slice_3/s_axis] [get_bd_intf_pins axis_signal_gen_v6_3/m_axis]
  connect_bd_intf_net -intf_net s_axi2_1 [get_bd_intf_pins s_axi2] [get_bd_intf_pins axis_signal_gen_v6_2/s_axi]
  connect_bd_intf_net -intf_net s_axi3_1 [get_bd_intf_pins s_axi3] [get_bd_intf_pins axis_signal_gen_v6_3/s_axi]
  connect_bd_intf_net -intf_net s_axi_0_1 [get_bd_intf_pins s_axi_0] [get_bd_intf_pins axis_signal_gen_v6_0/s_axi]
  connect_bd_intf_net -intf_net s_axi_1_1 [get_bd_intf_pins s_axi_1] [get_bd_intf_pins axis_signal_gen_v6_1/s_axi]
  connect_bd_intf_net -intf_net s_axis_0_1 [get_bd_intf_pins s_axis_0] [get_bd_intf_pins axis_signal_gen_v6_0/s0_axis]
  connect_bd_intf_net -intf_net s_axis_1_1 [get_bd_intf_pins s_axis_1] [get_bd_intf_pins axis_signal_gen_v6_1/s0_axis]
  connect_bd_intf_net -intf_net s_axis_2_1 [get_bd_intf_pins s_axis_2] [get_bd_intf_pins axis_signal_gen_v6_2/s0_axis]
  connect_bd_intf_net -intf_net s_axis_3_1 [get_bd_intf_pins s_axis_3] [get_bd_intf_pins axis_signal_gen_v6_3/s0_axis]
  ...
  connect_bd_intf_net -intf_net sg_translator_0_m_gen_v6_axis1 [get_bd_intf_pins sg_translator_1/m_gen_v6_axis] [get_bd_intf_pins axis_register_slice_5/S_AXIS]
  connect_bd_intf_net -intf_net sg_translator_0_m_gen_v6_axis2 [get_bd_intf_pins sg_translator_2/m_gen_v6_axis] [get_bd_intf_pins axis_register_slice_6/S_AXIS]
  connect_bd_intf_net -intf_net sg_translator_0_m_gen_v6_axis3 [get_bd_intf_pins sg_translator_3/m_gen_v6_axis] [get_bd_intf_pins axis_register_slice_7/S_AXIS]

  # Create port connections
  connect_bd_net -net rst_dac2_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins axis_cdcsync_v1_0/m_axis_aresetn] [get_bd_pins sg_translator_3/aresetn] [get_bd_pins axis_register_slice_7/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_signal_gen_v6_3/aresetn] [get_bd_pins sg_translator_2/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_signal_gen_v6_2/aresetn] [get_bd_pins sg_translator_1/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_signal_gen_v6_1/aresetn] [get_bd_pins sg_translator_0/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_signal_gen_v6_0/aresetn]
  connect_bd_net -net rst_dac3_peripheral_aresetn [get_bd_pins aresetn1] [get_bd_pins axis_cdcsync_v1_0/s_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn1 [get_bd_pins s_axi_aresetn] [get_bd_pins axis_signal_gen_v6_0/s0_axis_aresetn] [get_bd_pins axis_signal_gen_v6_0/s_axi_aresetn] [get_bd_pins axis_signal_gen_v6_1/s_axi_aresetn] [get_bd_pins axis_signal_gen_v6_3/s_axi_aresetn] [get_bd_pins axis_signal_gen_v6_2/s_axi_aresetn] [get_bd_pins axis_signal_gen_v6_1/s0_axis_aresetn] [get_bd_pins axis_signal_gen_v6_2/s0_axis_aresetn] [get_bd_pins axis_signal_gen_v6_3/s0_axis_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins aclk] [get_bd_pins axis_cdcsync_v1_0/m_axis_aclk] [get_bd_pins sg_translator_3/aclk] [get_bd_pins axis_register_slice_7/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_signal_gen_v6_3/aclk] [get_bd_pins sg_translator_2/aclk] [get_bd_pins axis_register_slice_6/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_signal_gen_v6_2/aclk] [get_bd_pins sg_translator_0/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_signal_gen_v6_0/aclk] [get_bd_pins sg_translator_1/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_signal_gen_v6_1/aclk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac4 [get_bd_pins aclk1] [get_bd_pins axis_cdcsync_v1_0/s_axis_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins s_axi_aclk] [get_bd_pins axis_signal_gen_v6_0/s0_axis_aclk] [get_bd_pins axis_signal_gen_v6_0/s_axi_aclk] [get_bd_pins axis_signal_gen_v6_1/s_axi_aclk] [get_bd_pins axis_signal_gen_v6_3/s_axi_aclk] [get_bd_pins axis_signal_gen_v6_2/s_axi_aclk] [get_bd_pins axis_signal_gen_v6_1/s0_axis_aclk] [get_bd_pins axis_signal_gen_v6_2/s0_axis_aclk] [get_bd_pins axis_signal_gen_v6_3/s0_axis_aclk]
...
proc create_hier_cell_readout_wrapper { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 m1_axis1
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins axis_dyn_readout_v1_0/m0_axis] [get_bd_intf_pins m0_axis1]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_broadcaster_0_M00_AXIS] [get_bd_intf_pins axis_avg_buffer_0/s_axis] [get_bd_intf_pins s_axis]
  ...
  connect_bd_intf_net -intf_net axis_clk_cnvrt_avg_0_M_AXIS [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_clk_cnvrt_avg_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_dyn_readout_v1_0_m1_axis [get_bd_intf_pins axis_dyn_readout_v1_0/m1_axis] [get_bd_intf_pins axis_broadcaster_0/S_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dyn_readout_v1_0_m1_axis] [get_bd_intf_pins axis_dyn_readout_v1_0/m1_axis] [get_bd_intf_pins m1_axis1]
  connect_bd_intf_net -intf_net axis_tmux_v1_0_m1_axis [get_bd_intf_pins s0_axis] [get_bd_intf_pins axis_cdcsync_v1_2/s0_axis]
  connect_bd_intf_net -intf_net axis_tmux_v1_0_m2_axis [get_bd_intf_pins s1_axis] [get_bd_intf_pins axis_cdcsync_v1_2/s1_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m20_axis [get_bd_intf_pins s1_axis1] [get_bd_intf_pins axis_dyn_readout_v1_0/s1_axis]

  # Create port connections
  connect_bd_net -net clk_core_clk_out1 [get_bd_pins m_axis_aclk1] [get_bd_pins axis_clk_cnvrt_avg_0/m_axis_aclk]
  connect_bd_net -net qick_processor_0_trig_10_o [get_bd_pins trigger] [get_bd_pins axis_avg_buffer_0/trigger]
  connect_bd_net -net rst_adc_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins sg_translator_16/aresetn] [get_bd_pins axis_avg_buffer_0/s_axis_aresetn] [get_bd_pins axis_cdcsync_v1_2/m_axis_aresetn] [get_bd_pins axis_dyn_readout_v1_0/aresetn] [get_bd_pins axis_broadcaster_0/aresetn]
  connect_bd_net -net rst_core_peripheral_aresetn [get_bd_pins m_axis_aresetn1] [get_bd_pins axis_clk_cnvrt_avg_0/m_axis_aresetn]
  connect_bd_net -net rst_dac3_peripheral_aresetn [get_bd_pins s_axis_aresetn1] [get_bd_pins axis_cdcsync_v1_2/s_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axis_aresetn] [get_bd_pins axis_clk_cnvrt_avg_0/s_axis_aresetn] [get_bd_pins axis_avg_buffer_0/s_axi_aresetn] [get_bd_pins axis_avg_buffer_0/m_axis_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins m_axis_aclk] [get_bd_pins sg_translator_16/aclk] [get_bd_pins axis_avg_buffer_0/s_axis_aclk] [get_bd_pins axis_cdcsync_v1_2/m_axis_aclk] [get_bd_pins axis_dyn_readout_v1_0/aclk] [get_bd_pins axis_broadcaster_0/aclk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac4 [get_bd_pins s_axis_aclk1] [get_bd_pins axis_cdcsync_v1_2/s_axis_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axis_aclk] [get_bd_pins axis_clk_cnvrt_avg_0/s_axis_aclk] [get_bd_pins axis_avg_buffer_0/s_axi_aclk] [get_bd_pins axis_avg_buffer_0/m_axis_aclk]
...
proc create_hier_cell_ddr4 { parentCell nameHier } {
  ...
  # Create instance: axis_buffer_ddr, and set properties
  set axis_buffer_ddr [ create_bd_cell -type ip -vlnv QICK:QICK:axis_buffer_ddr:1.1 axis_buffer_ddr ]
  set_property -dict [list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins S_AXIS]
  connect_bd_intf_net -intf_net axis_buffer_ddr_v1_0_m_axi [get_bd_intf_pins axi_smc_1/S01_AXI] [get_bd_intf_pins axis_buffer_ddr/m_axi]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins axis_buffer_ddr/s_axis] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS] [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M22_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins axis_buffer_ddr/s_axi]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins rst_ddr4/peripheral_aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins axis_buffer_ddr/aresetn]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins c0_ddr4_ui_clk] [get_bd_pins rst_ddr4/slowest_sync_clk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_buffer_ddr/aclk]
  ...
  connect_bd_net -net qick_processor_0_trig_9_o [get_bd_pins trigger] [get_bd_pins axis_buffer_ddr/trigger]
  connect_bd_net -net rst_100_bus_struct_reset [get_bd_pins sys_rst] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_adc_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axis_buffer_ddr/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axis_buffer_ddr/s_axi_aclk]
...
\
  ...
  connect_bd_intf_net -intf_net axis_clk_cnvrt_avg_0_M_AXIS [get_bd_intf_pins readout_wrapper/M_AXIS] [get_bd_intf_pins qick_processor_0/s0_axis]
  connect_bd_intf_net -intf_net axis_register_slice_0_m_axis [get_bd_intf_pins signal_gen_wrapper/m_axis_0] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  connect_bd_intf_net -intf_net axis_switch_0_M00_AXIS [get_bd_intf_pins signal_gen_wrapper/s_axis_0] [get_bd_intf_pins axis_switch_gen/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_switch_gen_M01_AXIS [get_bd_intf_pins axis_switch_gen/M01_AXIS] [get_bd_intf_pins signal_gen_wrapper/s_axis_1]
  connect_bd_intf_net -intf_net axis_switch_gen_M02_AXIS [get_bd_intf_pins axis_switch_gen/M02_AXIS] [get_bd_intf_pins signal_gen_wrapper/s_axis_2]
  connect_bd_intf_net -intf_net axis_switch_gen_M03_AXIS [get_bd_intf_pins axis_switch_gen/M03_AXIS] [get_bd_intf_pins signal_gen_wrapper/s_axis_3]
  ...
  connect_bd_intf_net -intf_net axis_tmux_v1_0_m1_axis [get_bd_intf_pins readout_wrapper/s0_axis] [get_bd_intf_pins axis_tmux_v1_0/m1_axis]
  connect_bd_intf_net -intf_net axis_tmux_v1_0_m2_axis [get_bd_intf_pins readout_wrapper/s1_axis] [get_bd_intf_pins axis_tmux_v1_0/m2_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins debug_bridge_0/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins signal_gen_wrapper/s_axi_0] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins signal_gen_wrapper/s_axi_1]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins signal_gen_wrapper/s_axi2]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins ps8_0_axi_periph/M10_AXI] [get_bd_intf_pins signal_gen_wrapper/s_axi3]
  ...
  connect_bd_intf_net -intf_net qick_processor_0_m0_axis [get_bd_intf_pins qick_processor_0/m0_axis] [get_bd_intf_pins signal_gen_wrapper/s0_axis]
  connect_bd_intf_net -intf_net qick_processor_0_m1_axis [get_bd_intf_pins qick_processor_0/m1_axis] [get_bd_intf_pins signal_gen_wrapper/s1_axis]
  connect_bd_intf_net -intf_net qick_processor_0_m2_axis [get_bd_intf_pins qick_processor_0/m2_axis] [get_bd_intf_pins signal_gen_wrapper/s2_axis]
  connect_bd_intf_net -intf_net qick_processor_0_m3_axis [get_bd_intf_pins qick_processor_0/m3_axis] [get_bd_intf_pins signal_gen_wrapper/s3_axis]
  connect_bd_intf_net -intf_net qick_processor_0_m4_axis [get_bd_intf_pins qick_processor_0/m4_axis] [get_bd_intf_pins axis_tmux_v1_0/s_axis]
  ...
  connect_bd_intf_net -intf_net readout_wrapper_m0_axis1 [get_bd_intf_pins axis_switch_mr/S00_AXIS] [get_bd_intf_pins readout_wrapper/m0_axis1]
  connect_bd_intf_net -intf_net signal_gen_wrapper_m_axis_1 [get_bd_intf_pins signal_gen_wrapper/m_axis_1] [get_bd_intf_pins usp_rf_data_converter_0/s01_axis]
  connect_bd_intf_net -intf_net signal_gen_wrapper_m_axis_2 [get_bd_intf_pins signal_gen_wrapper/m_axis_2] [get_bd_intf_pins usp_rf_data_converter_0/s02_axis]
  connect_bd_intf_net -intf_net signal_gen_wrapper_m_axis_3 [get_bd_intf_pins signal_gen_wrapper/m_axis_3] [get_bd_intf_pins usp_rf_data_converter_0/s03_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m20_axis [get_bd_intf_pins readout_wrapper/s1_axis1] [get_bd_intf_pins usp_rf_data_converter_0/m20_axis]
  ...
  connect_bd_net -net clk_core_clk_out1 [get_bd_pins clk_rst_wrapper/slowest_sync_clk1] [get_bd_pins readout_wrapper/m_axis_aclk1] [get_bd_pins qick_processor_0/c_clk_i]
  ...
  assign_bd_address -offset 0x000400100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs readout_wrapper/axis_avg_buffer_0/s_axi/reg0] -force
  assign_bd_address -offset 0x000402000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4/axis_buffer_ddr/s_axi/reg0] -force
  assign_bd_address -offset 0x000400300000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs signal_gen_wrapper/axis_signal_gen_v6_0/s_axi/reg0] -force
  assign_bd_address -offset 0x000400310000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs signal_gen_wrapper/axis_signal_gen_v6_1/s_axi/reg0] -force
  assign_bd_address -offset 0x000400320000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs signal_gen_wrapper/axis_signal_gen_v6_2/s_axi/reg0] -force
  assign_bd_address -offset 0x000400330000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs signal_gen_wrapper/axis_signal_gen_v6_3/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x0004FFFF0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs debug_bridge_0/S_AXI/Reg0] -force
  ...
  assign_bd_address -offset 0x000401000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qick_processor_0/s_axi/reg0] -force
  assign_bd_address -offset 0x000407000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs usp_rf_data_converter_0/s_axi/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces ddr4/axis_buffer_ddr/m_axi] [get_bd_addr_segs ddr4/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
